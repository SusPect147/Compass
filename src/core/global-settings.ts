...
const TRANSLATIONS = {
    'ru': {
        ...
        'Cancel': 'Отмена',
        'Confirm': 'Подтвердить',
        // CUSTOM TILES STUDIO (auto-slice)
        'Add tile': 'Добавить тайл',
        'Upload image': 'Загрузить картинку',
        'Auto-slice tiles': 'Нарезать автоматически',
        'Cut manually (soon)': 'Вырезать вручную (скоро)',
        'choose how to cut the image': 'выберите, как нарезать картинку',
        'Slicing image…': 'Нарезаю картинку…',
        'Fragments found:': 'Найдено фрагментов:',
        'Click a fragment, then click a tile on the left to assign it.': 'Нажмите на фрагмент, затем на тайл слева, чтобы назначить его.',
        'No fragments found — make sure the image has a transparent background.': 'Фрагменты не найдены — убедитесь, что фон картинки прозрачный.',
        'Failed to slice the image.': 'Не удалось нарезать картинку.',
        'Failed to load image.': 'Не удалось загрузить картинку.',
        'Manual cutting is coming soon! For now use auto-slice or the classic per-tile cropper.': 'Ручная вырезка скоро появится! Пока используйте автонарезку или классический редактор тайла.',
        'Remove variant': 'Убрать вариант',
        'Texture source': 'Источник текстур',
        // SLICE PANEL v2
        'Click or drag & drop a PNG here': 'Нажмите или перетащите PNG сюда',
        'Slice by grid': 'Нарезать по сетке',
        'Cut manually': 'Вырезать вручную',
        'Drag rectangles on the image — each selection becomes a fragment.': 'Выделяйте прямоугольники на картинке — каждое выделение станет фрагментом.',
        'Finish manual cutting': 'Завершить ручную вырезку',
        'The grid produced no fragments — every cell is fully transparent.': 'Сетка не дала фрагментов — все ячейки полностью прозрачны.',
        'Upload an image first.': 'Сначала загрузите картинку.',
        // PAST VERSIONS
        'Past Versions': 'Прошлые версии',
        'Version': 'Версия',
        'Restore into editor': 'Восстановить в редактор',
        'No past versions yet. They appear automatically after you save changes to the map.': 'Прошлых версий пока нет. Они появляются автоматически после сохранения изменений карты.',
        'Save the map first — past versions appear after the first save.': 'Сначала сохраните карту — прошлые версии появляются после первого сохранения.',
        'Load this version into the editor? Your current canvas will be replaced (you can undo with Ctrl+Z).': 'Загрузить эту версию в редактор? Текущее полотно будет заменено (можно отменить через Ctrl+Z).',
        '✅ Version loaded into the editor. Press Save Map to make it permanent.': '✅ Версия загружена в редактор. Нажмите «Сохранить», чтобы закрепить её.',
        '❌ Failed to load version:': '❌ Не удалось загрузить версию:',
        'Automatic backups of this map. Every time you save changes, the previous state is stored here.': 'Автоматические резервные копии карты. При каждом сохранении прежнее состояние попадает сюда.',
        'No past versions yet.': 'Прошлых версий пока нет.',
